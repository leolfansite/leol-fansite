...
const socialTabs = [
  { id: "instagram", label: "Instagram", cta: "MASAAKIのInstagramを見る" },
  { id: "x", label: "X", cta: "MASAAKIのXを見る" },
  { id: "tiktok", label: "TikTok", cta: "MASAAKIのTikTokを見る" },
  { id: "youtube", label: "YouTube", cta: "MASAAKIのYouTubeを見る" },
];
...
function SocialTabs() {
  ...
  const tab = socialTabs.find((item) => item.id === activeTab);
...
function SocialEmbed({ type }) {
  if (type === "youtube") {
    return (
      <div className="youtube-frame">
        {/* TODO: YouTube embed URL */}
        <iframe
          title="MASAAKI YouTube latest"
          src="https://www.youtube.com/embed/videoseries?list=PL0000000000000000"
          loading="lazy"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowFullScreen
  ...
  if (type === "x") {
    return (
      <div className="embed-placeholder x-embed">
        {/* TODO: X timeline embed code */}
        <p>Xの公式埋め込みタイムラインをここに表示します。</p>
        <span>Dark theme / height 500px</span>
      </div>
    );
  }
  ...
  if (type === "tiktok") {
    return (
      <div className="embed-placeholder">
        ...
        <p>TikTokプロフィールまたは動画埋め込みをここに表示します。</p>
      </div>
    );
  }
  ...
  return (
    <div className="embed-placeholder">
      ...
      <p>Instagram投稿またはプロフィール埋め込みをここに表示します。</p>
    </div>
  );
}
